...
import { MountedTextInput, TextInput } from "./components/TextInput/TextInput";
  ...
  return (
    <div className="w-screen h-screen bg-gray-900 flex items-center justify-center text-gray-100 flex-col">
      ...
      <form className="flex flex-col items-stretch w-full max-w-sm mt-10 gap-4">
        ...
        <label htmlFor="remember" className="flex items-center gap-2 mb-8">
      ...
      <footer className="flex flex-col items-center gap-4 mt-8">
        <Text
          asChild
          size="sm"
          className="underline text-gray-400 hover:text-gray-200 transition"
        >
